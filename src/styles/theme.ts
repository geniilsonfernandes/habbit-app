...
const DARK_THEME = {
  ...
  habit: {
    red: { 600: '#662020', 500: '#DD2626', 700: '#dd26266b' },
    green: { 600: '#22442C', 500: '#43AB65', 700: '#43ab6683' },
  ...
  danger: {
    ...
    500: '#FFCACD',
    gradient: {
      100: 'linear-gradient(138.83deg, #FF7171 4.52%, #FF4F4F 104.14%)',
      200: 'linear-gradient(138.83deg, #FF8787 4.52%, #FF623D 104.14%)',
      300: 'linear-gradient(138.83deg, #FF9D9D 4.52%, #FF7C52 104.14%)',
      400: 'linear-gradient(138.83deg, #FFB4B4 4.52%, #FF925E 104.14%)',
      500: 'linear-gradient(138.83deg, #FFCACD 4.52%, #FFA463 104.14%)',
      600: 'linear-gradient(138.83deg,#000000 4.52%, #120e46  104.14%)',
    },
  },
  secondary: {
